...
class TestAudioFileWriter(unittest.TestCase):
    def setUp(self):
        ...
        self.mock_pcm_float_converter = mock.patch(
            "wavealign.data_collection.audio_file_writer.PcmFloatConverter"
        ).start()
        self.mock_write = mock.patch(
            "wavealign.data_collection.audio_file_writer.audio.write"
        ).start()
        self.mock_write_metadata = mock.patch(
            "wavealign.data_collection.audio_file_writer.write_metadata"
        ).start()
    ...
    def test_write(self):
        ...
        AudioFileWriter().write("some_path", self.mock_audio_data, self.mock_metadata)
    ...
    def test_write_with_conversion(self):
        ...
        self.mock_pcm_float_converter.return_value.float_to_pcm.return_value = (
