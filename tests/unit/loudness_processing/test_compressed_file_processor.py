...
class TestCompressedFileProcessor(unittest.TestCase):
    def setUp(self):
        self.mock_get_aacgain_executable_path = mock.patch(
            "wavealign.loudness_processing.compressed_file_processor.get_aacgain_executable_path"
        ).start()
    ...
    def test_process(self):
        ...
        self.mock_subprocess_run.assert_called_once_with(
            [
                self.mock_get_aacgain_executable_path.return_value,
                "-q",
                "-g",
                "0.0",
        ...
        self.mock_get_aacgain_executable_path.assert_called_once()
