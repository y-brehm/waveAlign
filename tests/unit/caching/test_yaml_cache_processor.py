...
class TestYamlCacheProcessor(unittest.TestCase):
    ...
    def test_read_cache_exists(
        self, mock_dict_to_dataclass_converter, mock_yaml_load, mock_exists, mock_open
    ):
        ...
        mock_dict_to_dataclass_converter.return_value.process.return_value = dummy_dataclass
